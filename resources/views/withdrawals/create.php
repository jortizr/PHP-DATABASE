...
<head>
    ...
    <title>Agrega un nuevo retiro</title>
</head>
<body>
            <a href="/withdrawals" class="button">
    ...
    <div class="modal">
        <form action="/withdrawals" method="post" class="form">
        <p class="title">Nuevo retiro</p>
            <div class="separator">
            <hr class="line">
            <p>registra un nuevo retiro</p>
            <hr class="line">
        </div>
        <div class="input_container">
            <label for="payment_method" class="input_label">Metodo de retiro</label>
        ...
        <div class="input_container">
            <label for="type" class="input_label">Tipo de retiro</label>
            <select name="type" id="type" class="input_field">
                <option class="input_field" value="1" selected>Retiro</option>
                <option class="input_field" value="2">Compra</option>
            </select>
        </div>
        <div class="input_container">
